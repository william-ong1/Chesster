...
export function ChessPiece({ type, color }: ChessPieceProps) {
  ...
  const stroke = color === 'w' ? '#000000' : '#ffffff';
    ...
    B: ( // Bishop
      <svg viewBox="0 0 45 45" className="w-16 h-16">
        <g fill={fill} stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M 17.5,26 L 27.5,26" fill="none" strokeLinecap="butt"/>
    ...
    N: ( // Knight
      <svg viewBox="0 0 45 45" className="w-16 h-16">
        <g fill={fill} stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M 9.5,25.5 A 0.5,0.5 0 1 1 8.5,25.5 A 0.5,0.5 0 1 1 9.5,25.5 z" fill={color === 'w' ? '#000000' : '#ffffff'} stroke="none"/>
          <path d="M 15,15.5 A 0.5,1.5 0 1 1 14,15.5 A 0.5,1.5 0 1 1 15,15.5 z" fill={color === 'w' ? '#000000' : '#ffffff'} stroke="none" transform="rotate(30 14.5 15.5)"/>
        </g>
      </svg>
    ),
    P: ( // Pawn
      <svg viewBox="0 0 45 45" className="w-16 h-16">
        <g fill={fill} stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M 20,18 C 20,18 18,21 18,25 L 18,30 L 15,33 L 15,36 L 30,36 L 30,33 L 27,30 L 27,25 C 27,21 25,18 25,18 L 20,18 z"/>
        </g>
      </svg>
    ),
  };
